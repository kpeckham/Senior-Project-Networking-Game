...
public class randomChecksumGenerator1 : MonoBehaviour {
	...
	List<string> generateSum(int width, int percentageCorrect) {
		...
		string binarynum1 = Convert.ToString (num1, 2).PadLeft(4, '0');
		string binarynum2 = Convert.ToString (num2, 2).PadLeft(4, '0');
		string binarysum = Convert.ToString (sum, 2).PadLeft(4, '0');
